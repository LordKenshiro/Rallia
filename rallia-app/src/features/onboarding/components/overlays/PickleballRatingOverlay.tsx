  ...
  const ratings: Rating[] = [
    {
      ...
      level: 'Beginner',
      dupr: 'DUPR 2.0',
      description: 'Just getting started. Short rallies (1-2 shots). Learning basic scoring knowledge.',
      isHighlighted: false,
    },
    {
    ...
    },
    {
      ...
      dupr: 'DUPR 4.0',
      description: 'Plays longer rallies with patience. Aware of positioning. Uses varied shots. Mixing power and soft shots.',
      isHighlighted: false,
    },
    {
      id: 'advanced',
      level: 'Advanced',
      dupr: 'DUPR 4.5',
      description: 'Strong consistency and power. Varied shots. Faster speed. Comfortable crashing near the kitchen.',
      isHighlighted: true,
    },
    {
      id: 'elite',
      level: 'Elite',
      dupr: 'DUPR 5.0+',
      description: 'Highest level of shot types. Rarely makes unforced errors. Plays competitively.',
      isHighlighted: false,
    },
  ];
