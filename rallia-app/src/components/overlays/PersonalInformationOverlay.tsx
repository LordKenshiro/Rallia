...
const PersonalInformationOverlay: React.FC<PersonalInformationOverlayProps> = ({ 
  ...
  const handleContinue = () => {
    console.log('Personal info:', { fullName, username, dateOfBirth: formatDate(dateOfBirth), gender, phoneNumber, profileImage });
      ...
      <View style={styles.container}>
        ...
        {Platform.OS === 'web' ? (
          ...
          <TouchableOpacity 
            ...
            activeOpacity={0.8}
          >
            <Text style={[styles.inputField, styles.inputText, !dateOfBirth && styles.placeholderText]}>
