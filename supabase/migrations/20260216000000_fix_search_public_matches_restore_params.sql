-- ============================================================================
-- Migration: Fix search_public_matches - restore missing parameters
-- Created: 2026-02-16
-- Description: The migration 20260207000000_standardize_gender_enum.sql
--   accidentally recreated search_public_matches with only 16 parameters,
--   dropping p_duration, p_court_status, p_specific_date, and p_facility_id
--   that were added in migrations 20260121100000 and 20260128000004.
--   This restores the full 20-parameter version with proper gender_enum casts.
-- ============================================================================

-- Drop the current 16-parameter version
...
COMMENT ON FUNCTION search_public_matches(
  DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, INT, INT, TEXT, UUID
) IS 'Search public matches with comprehensive filters including duration, court status, specific date, and facility. Always filters out matches that have already started today and full matches. Uses gender_enum for proper gender comparison.';
