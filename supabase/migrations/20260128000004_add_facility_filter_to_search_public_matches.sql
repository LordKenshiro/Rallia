-- ============================================================================
-- Migration: Add facility filter to search_public_matches
-- Created: 2026-01-28
-- Description: Adds p_facility_id parameter to filter matches by facility.
--   When set, only returns matches at that specific facility.
-- ============================================================================

-- Drop the existing function to recreate with new parameter
...
COMMENT ON FUNCTION search_public_matches(
  DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, INT, INT, TEXT, UUID
) IS 'Search public matches with comprehensive filters including duration, court status, specific date, and facility. Always filters out matches that have already started today. Uses match timezone for accurate time comparison.';
