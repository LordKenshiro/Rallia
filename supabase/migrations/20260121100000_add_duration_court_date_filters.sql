-- ============================================================================
-- Migration: Add duration, court status, and specific date filters
-- Created: 2026-01-21
-- Description: Adds three new filtering parameters to search_public_matches:
--   - p_duration: Filter by match duration (30, 60, 90, 120+)
--   - p_court_status: Filter by court reservation status (reserved, to_reserve)
--   - p_specific_date: Filter by specific date (overrides dateRange when set)
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION search_public_matches(
  DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, INT, INT, TEXT
) TO authenticated;
GRANT EXECUTE ON FUNCTION search_public_matches(
  DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, INT, INT, TEXT
) TO anon;

COMMENT ON FUNCTION search_public_matches IS 'Search public matches with comprehensive filters including duration, court status, and specific date. Always filters out matches that have already started today. Uses match timezone for accurate time comparison.';
