-- =============================================================================
-- Migration: Repair Tampered Schema
-- Description: Re-applies all schema elements from migrations that were tampered with.
--              This is idempotent - safe to run multiple times.
-- Created: 2026-02-18
-- Re-applies: 
--   - 20260206000000_sync_missing_schema_elements.sql
--   - 20260206100000_fix_community_access_control.sql
--   - 20260206110000_add_group_activity_table.sql
--   - 20260214000000_fix_creator_not_added_as_member.sql
--   - 20260214100000_fix_check_community_access_types.sql
--   - 20260214110000_add_network_member_count_columns.sql
--   - 20260214120000_fix_member_count_values.sql
-- =============================================================================
...
-- =============================================================================
-- PART 4: MISSING COLUMNS (from 20260206000000)
-- =============================================================================
...
-- Network columns (from 20260214110000)
...
-- =============================================================================
-- PART 5: MISSING FOREIGN KEY CONSTRAINTS (from 20260206000000)
-- =============================================================================
...
-- =============================================================================
-- PART 6: MISSING INDEXES (from 20260206000000)
-- =============================================================================
...
-- =============================================================================
-- PART 7: ENABLE RLS ON TABLES (from 20260206000000)
-- =============================================================================
...
-- =============================================================================
-- PART 8: RLS POLICIES (from 20260206000000)
-- =============================================================================
...
-- =============================================================================
-- PART 9: INSERT MISSING NETWORK TYPE
-- =============================================================================
...
-- auto_add_creator_as_moderator function (from 20260214000000)
...
-- update_network_member_count function (from 20260214110000)
...
-- =============================================================================
-- PART 11: FIX EXISTING DATA (from 20260214000000, 20260214120000)
-- =============================================================================
...
DO $$
BEGIN
  RAISE NOTICE 'Schema repair migration completed successfully';
END $$;
