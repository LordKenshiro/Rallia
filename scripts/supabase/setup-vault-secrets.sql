...
--   - anon_key: REQUIRED for send-notification and send-email triggers (Bearer auth).
--     Triggers use anon_key, not service_role_key. Get from: env | grep ANON_KEY
--
...
--   - anon_key: Your anon/publishable JWT from Supabase dashboard (API > Project API keys)
-- ============================================================================

-- Check current secrets status (all three required for notification/email triggers)
SELECT 
  name,
  CASE 
...
-- Local anon key (demo): eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5ODM4MTI5OTZ9.CRXP1A7WOeoJe5xjztHsZOlhAW7GtblmOx4FQw-s16E
/*
...
SELECT vault.create_secret('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5ODM4MTI5OTZ9.CRXP1A7WOeoJe5xjztHsZOlhAW7GtblmOx4FQw-s16E', 'anon_key');
*/
