...
const ShareMatchModal: React.FC<ShareMatchModalProps> = ({
  ...
  const handleSelectAllFromList = useCallback((list: SharedContactList) => {
  ...
  const renderListItem = useCallback(({ item }: { item: SharedContactList }) => {
    ...
    return (
      <View style={[styles.listItem, { borderColor: colors.border }]}>
        ...
        >
          <View style={[styles.listIcon, { backgroundColor: isDark ? primary[800] : primary[100] }]}>
        ...
        {isExpanded && (
          <View style={styles.contactsContainer}>
            {isLoadingThisList ? (
              ...
              <>
                <TouchableOpacity
                  style={[styles.selectAllButton, { backgroundColor: isDark ? neutral[800] : neutral[100] }]}
        ...
        return (
          <View style={styles.stepContent}>
            ...
            <View style={styles.shareOptions}>
              <TouchableOpacity
                style={[styles.shareOption, { backgroundColor: isDark ? neutral[800] : neutral[100] }]}
              ...
              >
                <Ionicons name="chatbubble-outline" size={24} color={selectedContacts.some(c => c.phone) ? colors.primary : colors.textMuted} />
                <Text style={{ color: selectedContacts.some(c => c.phone) ? colors.text : colors.textMuted, marginTop: spacingPixels[1] }}>SMS</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                disabled={isSharing || !selectedContacts.some(c => c.phone)}
              >
                <Ionicons name="logo-whatsapp" size={24} color={selectedContacts.some(c => c.phone) ? '#25D366' : colors.textMuted} />
                <Text style={{ color: selectedContacts.some(c => c.phone) ? colors.text : colors.textMuted, marginTop: spacingPixels[1] }}>WhatsApp</Text>
              </TouchableOpacity>
              ...
              >
                <Ionicons name="mail-outline" size={24} color={selectedContacts.some(c => c.email) ? colors.primary : colors.textMuted} />
                <Text style={{ color: selectedContacts.some(c => c.email) ? colors.text : colors.textMuted, marginTop: spacingPixels[1] }}>Email</Text>
              </TouchableOpacity>
            </View>
    ...
    >
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.stepIndicator}>
          ...
          <View style={[styles.stepLine, { backgroundColor: step !== 'select-match' ? colors.primary : colors.border }]} />
          <View style={[styles.stepDot, { backgroundColor: step !== 'select-match' ? colors.primary : colors.border }]} />
          <View style={[styles.stepLine, { backgroundColor: step === 'confirm' ? colors.primary : colors.border }]} />
          <View style={[styles.stepDot, { backgroundColor: step === 'confirm' ? colors.primary : colors.border }]} />
        </View>
