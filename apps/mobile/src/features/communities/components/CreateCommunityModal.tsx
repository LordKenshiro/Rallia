...
interface CreateCommunityModalProps {
  visible: boolean;
  onClose: () => void;
  onSubmit: (name: string, description?: string, coverImageUrl?: string, isPublic?: boolean) => Promise<void>;
  isLoading?: boolean;
}
...
export function CreateCommunityModal({
  ...
  const handlePickImage = useCallback(async () => {
    try {
      ...
      if (status !== 'granted') {
        Alert.alert(t('community.permissionRequired' as any), t('community.photoAccessRequired' as any));
        return;
      }
        ...
        <View style={[styles.container, { backgroundColor: colors.cardBackground }]}>
          ...
          <View style={[styles.header, { borderBottomColor: colors.border }]}>
            <Text weight="semibold" size="lg" style={{ color: colors.text }}>
              {t('community.createCommunity' as any)}
            </Text>
          ...
          <ScrollView style={styles.scrollContent} contentContainerStyle={styles.content}>
            ...
            <View style={styles.inputGroup}>
              <Text weight="medium" size="sm" style={{ color: colors.text, marginBottom: 8 }}>
                {t('community.communityImage' as any)}
              </Text>
              {coverImage ? (
            ...
            {/* Visibility Toggle */}
            <View style={[styles.visibilityToggle, { backgroundColor: isDark ? '#1C1C1E' : '#F2F2F7' }]}>
              <View style={styles.visibilityLeft}>
                <View style={[styles.visibilityIcon, { backgroundColor: isPublic ? '#34C75920' : '#FF950020' }]}>
                  <Ionicons 
            ...
            >
              {isSubmitting ? (
                ...
                <Text weight="semibold" style={{ color: '#FFFFFF' }}>
                  {t('community.createCommunityButton' as any)}
                </Text>
              )}
            </TouchableOpacity>
          </View>
