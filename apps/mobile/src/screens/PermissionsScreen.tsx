...
const PermissionsScreen: React.FC = () => {
  ...
  const checkAllPermissions = async () => {
    const [notifStatus, locationStatus, calendarStatus, photosStatus, contactsStatus, cameraStatus] = await Promise.all([
  ...
  const permissionList: PermissionInfo[] = useMemo(
    () =>
      (['notifications', 'location', 'calendar', 'photos', 'contacts', 'camera'] as PermissionType[]).map(type => ({
        type,
